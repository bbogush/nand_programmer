...
"""
    ...
    Fields are (if exist)
    Ref, Quantity, Value, Part, Datasheet, Description, Vendor, Farnel Ref
...
row += "<th>Qnty</th>"
row += "<th>Value</th>" + "<th>Footprint</th>"
row += "<th>Description</th>"
row += "<th>Farnell Ref</th></tr>"
...
for group in grouped:
    ...
    row += "</td><td>" + c.getField("Farnell Ref") + "</td></tr>"
